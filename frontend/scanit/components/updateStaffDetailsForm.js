...
const updateStaffDetailsForm = (data) => {
    ...
    <View mx="8">
        ...
        <CustomInput 
            ...
            rules = {{
                ...
                />
        <Text>&nbsp;</Text>
        <Button bg="brand.400" width="100%" maxWidth="300px" onPress={handleSubmit(onUpdatePressed)} title={"Edit staff"}>Edit staff</Button>
        <Text>&nbsp;</Text>
        </View>
    </Box>
...
export default updateStaffDetailsForm;