...
import { Container, Header, Title, Body, Flex, Spacer, Divider, useColorMode } from 'native-base';
...
function Home() {
    ...
    return (
        ...
        <Flex flex={1} alignItems="center" safeAreaTop>
            ...
            {isRetailerScanned ?
                <View>
                    <Box borderWidth={1} borderColor="gray.200" width={300} borderRadius={10} p={4} bg={{linearGradient: {
                            colors: ['#0984e3', 'violet.800'],
                            start: [0, 0],
                            end: [1, 0]
                        }}}>
                        <Text color="white" style={{ fontFamily: 'Rubik-Bold' }}>Shopping with</Text>
                        <Text color="white">Retailer: {retailerBarcodeData}</Text>
                        <Text>&nbsp;</Text>
                        <Button bg="brand.400" onPress={() => {
                        Alert.alert(
                            'Clear Retailer',
                ...
                <TouchableOpacity onPress={() => router.push('/home/Scan')}>
                    <Box size={150} width={300} borderRadius={10} borderWidth={1} borderColor="gray.200"
                        bg={{linearGradient: {
                            colors: ['#0984e3', 'violet.800'],
                            start: [0, 0],
                            end: [1, 0]
